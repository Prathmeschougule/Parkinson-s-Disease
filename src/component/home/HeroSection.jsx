  ...
  return (
    ...
    <div>
      <div className=" h-100  w-screen text-center  flex flex-col items-center justify-center bg-blue-50">
        ...
        <h1 className="text-4xl sm:text-6xl lg:text-8xl font-bold bg-gradient-to-r from-emerald-800 to-emerald-400 bg-clip-text text-transparent">
          Parkinson’s Disease
        </h1>
        <p className="text-[15px] sm:text-lg lg:text-xl mt-3 text-black">Specially designed physiotherapy
